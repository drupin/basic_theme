...
function basic_widgets_init() {
  ...
  // Register widgets
  register_widget('Basic_Vcard_Widget');
}
add_action('widgets_init', 'basic_widgets_init');

// Example vCard widget
class Basic_Vcard_Widget extends WP_Widget {
  function Basic_Vcard_Widget() {
    $widget_ops = array('classname' => 'widget_basic_vcard', 'description' => __('Use this widget to add a vCard', 'basic'));
    $this->WP_Widget('widget_basic_vcard', __('Basic: vCard', 'basic'), $widget_ops);
    $this->alt_option_name = 'widget_basic_vcard';
  ...
  function widget($args, $instance) {
    $cache = wp_cache_get('widget_basic_vcard', 'widget');
    ...
    $title = apply_filters('widget_title', empty($instance['title']) ? __('vCard', 'basic') : $instance['title'], $instance, $this->id_base);
  ...
  <?php
    ...
    wp_cache_set('widget_basic_vcard', $cache, 'widget');
  }
  ...
  function update($new_instance, $old_instance) {
    ...
    if (isset($alloptions['widget_basic_vcard'])) {
      delete_option('widget_basic_vcard');
    }
  ...
  function flush_widget_cache() {
    wp_cache_delete('widget_basic_vcard', 'widget');
  }
  ...
  ?>
    ...
    <p>
      <label for="<?php echo esc_attr($this->get_field_id('street_address')); ?>"><?php _e('Street Address:', 'basic'); ?></label>
    ...
    <p>
      <label for="<?php echo esc_attr($this->get_field_id('locality')); ?>"><?php _e('City/Locality:', 'basic'); ?></label>
    ...
    <p>
      <label for="<?php echo esc_attr($this->get_field_id('region')); ?>"><?php _e('State/Region:', 'basic'); ?></label>
    ...
    <p>
      <label for="<?php echo esc_attr($this->get_field_id('postal_code')); ?>"><?php _e('Zipcode/Postal Code:', 'basic'); ?></label>
    ...
    <p>
      <label for="<?php echo esc_attr($this->get_field_id('tel')); ?>"><?php _e('Telephone:', 'basic'); ?></label>
    ...
    <p>
      <label for="<?php echo esc_attr($this->get_field_id('email')); ?>"><?php _e('Email:', 'basic'); ?></label>
